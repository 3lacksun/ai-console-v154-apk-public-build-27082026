...
const createStyles = (colors) => StyleSheet.create({
  ...
  smallButton: { minHeight: 44, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.cyanDim, borderRadius: radii.sm },
  smallButtonWide: { minHeight: 44, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.cyanBorder, borderRadius: radii.sm, backgroundColor: colors.cyanDim },
