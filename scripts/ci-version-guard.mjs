...
if (pkg.version !== '1.5.4') fail(`package.json version drift: ${pkg.version}`);
...
if (expo.android?.versionCode !== 19) fail(`Android versionCode drift: ${expo.android?.versionCode}`);
