...
assert(pkg.dependencies?.['expo-audio']==='~57.0.4'&&pkg.dependencies?.['expo-asset']==='~57.0.15'&&pkg.dependencies?.['@react-native-picker/picker']==='2.11.4'&&app.expo.plugins?.some((entry)=>(Array.isArray(entry)?entry[0]:entry)==='expo-audio')&&app.expo.plugins?.some((entry)=>(Array.isArray(entry)?entry[0]:entry)==='expo-asset'),'Together Sonic playback/voice-picker native dependencies or configuration missing');
