...
assert(app.expo.version==='1.5.4'&&app.expo.android.versionCode===21&&app.expo.android.package==='com.nexarenew.aiconsole','Expo/Android release identity drift');
...
assert(streamChat.includes('fetchTogetherSonicVoices')&&streamChat.includes('createTogetherSonicSpeech')&&streamChat.includes("response_format: 'mp3'"),'Together Sonic voice/speech client missing');
