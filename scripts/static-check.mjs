...
assert(pkg.dependencies?.['expo-audio']==='~57.0.4'&&pkg.dependencies?.['@react-native-picker/picker']==='2.11.4'&&app.expo.plugins?.some((entry)=>(Array.isArray(entry)?entry[0]:entry)==='expo-audio'),'Together Sonic playback/voice-picker native dependencies or configuration missing');
